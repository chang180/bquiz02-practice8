...
<body>
	...
	<div id="all">
		<div id="title">
			<?= date("m月d號l"); ?> | 今日瀏覽: <?= $today['total']; ?> | 累積瀏覽: <?= $total; ?> </div>
		<div id="title2">
				...
				<div>
					...
					<span style="width:18%; display:inline-block;">
						...
						<?php
							...
							echo "歡迎，admin<br><a href='admin.php'>管理</a>|<a href='api/logout.php'>登出</a>";
						} else {
							echo "歡迎，" . $_SESSION['login'] . "<a href='api/logout.php'>登出</a>";
						}
						?>
					</span>
					<?php
